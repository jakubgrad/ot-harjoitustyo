...
class LoginView:
    ...
    def _initialize(self):
        ...
        registration_button.grid(row=4, column=0, columnspan=2, sticky=(constants.E, constants.W), padx=5, pady=5)
    ...
    def _handle_login_click(self):
        ...
        if user_repository.login(username_entry, password_entry):
