...
You'll get `Administration` view, which currently allows you to put e.g. new named types of heating and how much pollution and electricity they produce relative to the existing methods. You can also update the pollution and electricity that depends on house age using a similar form.<br>
<p align="center">
